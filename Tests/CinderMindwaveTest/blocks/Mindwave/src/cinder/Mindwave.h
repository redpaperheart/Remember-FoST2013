...
class Mindwave {
  public:
	...
	bool connect();
	bool update(); // return true if data is new
  ...
  private:
	...
	int mSignalQuality;	// poor signal status 0 to 255
	int mAttention;		// eSense attention 0 to 100
	int mMeditation;		// eSense meditation o to 100
	int mRaw;
	int mDelta;
	int mTheta;
	int mAlpha1;
	...
	int mGamma1;
	int mGamma2;
	int mBlinkStrength; // 0-255 always returns most recent blink
